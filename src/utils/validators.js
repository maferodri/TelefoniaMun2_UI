...
/**
 * Valida el formato de email segun el patron del backend
...
export const isValidPhone = (phone) => {
  // Permite formatos tipo: 9999-9999, +504 9999-9999, 5049999-9999, (504) 9999-9999
  const phoneRegex = /^(\+504\s?|504\s?|\(504\)\s?)?(\d{4})[- ]?(\d{4})$/;
